...
for aidx = 1:numel(archList)
    ...
    if max(abs(reconstructedGasLoss- ...
            double(Tlink.AtmosphericGasLoss_dB(idx)))) > 1e-10

        error("Stored %s gas losses do not follow the temporal secant model.", ...
            archList(aidx));
    end
end
...
leoLegend = legend( ...
    ...
    {'Full pool','FA result','Infeasible'}, ...
    'NumColumns',1, ...
    'FontName',fontName, ...
    'FontSize',legendFontSize, ...
    'Box','off', ...
...
hConditional = semilogy( ...
    axOutlier, ...
    Toutlier.B, ...
    Toutlier.RMSE_BE_ExactDetection_m, ...
    '--^', ...
    'Color',archColors(3,:), ...
    'LineWidth',lineWidth, ...
...
for k = 1:height(Toutlier)
    ...
    if Toutlier.B(k) > 0
        ...
        text( ...
            axOutlier, ...
            Toutlier.B(k), ...
            Toutlier.RMSE_BE_ExactDetection_m(k)*1.16, ...
            sprintf('%.2f%%',100*Toutlier.ExactDetectionProb(k)), ...
            'HorizontalAlignment','center', ...
            'VerticalAlignment','bottom', ...
            'FontName',fontName, ...
            'FontSize',annotationFontSize);
...
outlierLegend = legend( ...
    axOutlier, ...
    [hWLS,hRobust,hConditional], ...
    {'WLS','Robust BE','BE | exact detection'}, ...
    'NumColumns',1, ...
    'FontName',fontName, ...
    'FontSize',legendFontSize, ...
    'Box','off', ...
